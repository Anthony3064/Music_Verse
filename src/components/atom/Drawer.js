        ...
        <Block>
          ...
          <Block>
            <DrawerItem
              ...
              icon={() => <MIcons name="my-library-music" color="white" size={16} />}
            />
            <DrawerItem
              label="Playlists"
            ...
            />
              ...
              label="Reproductor"
              labelStyle={{ color: 'white', marginLeft: -16 }}
              onPress={() => props.navigation.navigate('Reproductor')}
              icon={() => <MIcons name="audiotrack" color="white" size={16} />}
            />
          </Block>
        </Block>
    ...
    return (
      <LinearGradient style={{ flex: 1 }} colors={['#34cfeb', '#b8cfd4']}>
        <Drawer.Navigator
          ...
          drawerContentOptions={{//estilo de los botones
